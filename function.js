...
function generateRandomWord() {
    ...
    //will be added more title with description soon!
    var title = [
    ...
    var description = [
        ...
        //logs displayed in the console if the description is match with the title.
        var array = "Barangay Management Information System";
